...
import { createChatSession, sendMessageToBarista } from '../services/geminiService';
...
const AiBarista: React.FC = () => {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    { role: 'model', text: 'Welcome to Eclipse. I am Orion. How may I guide your experience today?' }
  ]);
  ...
  const handleSend = async () => {
    ...
    const responseText = await sendMessageToBarista(chatSession.current, userMsg.text);
