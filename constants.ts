...
export const OFFERINGS: OfferingCategory[] = [
  {
    ...
    description: "A study in precision. Our espresso is pulled at exact temperatures to highlight the bright acidity and deep chocolate notes of our single-origin beans.",
  ...
  {
    title: "Slow Pour",
    description: "Time is the essential ingredient. Hand-poured V60 and Chemex brews that allow the complex floral and fruit notes to bloom gracefully.",
  ...
  },
  {
    ...
    description: "The perfect companion to your cup. Baked fresh every morning using traditional techniques and avant-garde flavor combinations.",
